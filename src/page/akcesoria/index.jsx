...
const services = [
	{
		...
		title: "Wykorzystywane Materiały",
		description:
			"Wybór materiałów ma kluczowe znaczenie dla jakości i trwałości naszych mebli. Korzystamy wyłącznie z renomowanych dostawców, aby zapewnić naszym klientom najwyższą jakość wykonania i estetykę.",
